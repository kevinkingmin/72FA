    ...
    m_curHanziPage(0)
{
    ...
    //m_labPyText->setStyleSheet("background: #a0f0ff; border-color: gray; border-width: 1px; border-style: solid; border-radius: 5px;");
...
void KeyboardForm::letterClicked()
{
    ...
    if (m_inputMode == ImNum ||m_inputMode == ImEn || m_shiftKey || text == "'")
    {
...
void KeyboardForm::hideEvent(QHideEvent *)
{
    m_cachePinYin.clear();
    m_labPyText->clear();
    m_labPyText->hide();
