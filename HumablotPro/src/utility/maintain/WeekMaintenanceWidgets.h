...
namespace Ui {
	class WeekMaintenanceWidgetsClass;
}


class WeekMaintenanceWidgets : public QWidget
{
	Q_OBJECT

public:
	WeekMaintenanceWidgets(QWidget *parent = nullptr);
	~WeekMaintenanceWidgets();
...
private:
	...
	Ui::WeekMaintenanceWidgetsClass *ui;
...
public:
	...
	int m_i = 0;
	bool mWeekMaintenance_run_flage = false;
