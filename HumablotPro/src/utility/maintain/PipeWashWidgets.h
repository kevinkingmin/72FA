...
namespace Ui {
	class PipeWashWidgetsClass;
}

class PipeWashWidgets : public QWidget
{
	Q_OBJECT

public:
	PipeWashWidgets(QWidget *parent = nullptr);
	~PipeWashWidgets();

	using PumpPosState = GlobalData::PumpPosState;
private:
	Ui::PipeWashWidgetsClass *ui;
