...
void BatchAddSampleWidgets::GetTestPaperInfo()
{
	...
	*/
    ...
    ui.tvSampleSet->model()->removeRows(0, row_number);
    ...
    if(SystemSetDao::instance()->getModel(6, systemModel))
    {
        // 选中的流程id
        ...
        for(TestPaperModel& paper:paperModelVect)
        {
            ...
            // 设置文本
            pButton->setText(QString::fromLocal8Bit("%1").arg(paper.getPaperName()));
