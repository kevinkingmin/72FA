...
QString DataConvertHelper::byteArrayToHexStr(const QByteArray &data)
{
    QString temp = "";
...
QString DataConvertHelper::byteArrayToAsciiStr(const QByteArray &data)
{
    QString temp;
    int len = data.size();
    for (int i = 0; i < len; i++)
...
QByteArray DataConvertHelper::asciiStrToByteArray(const QString &str)
{
    QByteArray buffer;
    int len = str.length();
    QString letter;
...
QByteArray DataConvertHelper::hexStrToByteArray(const QString &str)
{
    QByteArray senddata;
...
QString DataConvertHelper::byteArrayToHexStr(const QByteArray &data, bool b)
{
    QString temp = "";
    QString hex = data.toHex();
    for (int i = 0; i < hex.length(); i = i + 2) {
