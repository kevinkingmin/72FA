...
#include "../src/utility/AddCompany.h"
...
QT_MOC_LITERAL(5, 56, 28) // "on_pushButton_Cancel_clicked"
    ...
    "AddCompany\0SetRefresh\0\0bFlag\0"
...
void AddCompany::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddCompany::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddCompany::SetRefresh)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddCompany::SetRefresh(bool _t1)
{
