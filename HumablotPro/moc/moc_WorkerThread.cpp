...
#include "../src/main/WorkerThread.h"
...
QT_MOC_LITERAL(1, 13, 16), // "sendDataToServer"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 3) // "str"

    },
    "WorkerThread\0sendDataToServer\0\0str"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendDataToServer((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::sendDataToServer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::sendDataToServer(QString _t1)
{
