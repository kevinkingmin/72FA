...
#include "../src/sample/SaveThread.h"
...
QT_MOC_LITERAL(1, 11, 8), // "savedone"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "getaddress"
QT_MOC_LITERAL(4, 32, 7) // "Widget*"

    },
    "SaveThread\0savedone\0\0getaddress\0Widget*"
};
...
void SaveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->savedone(); break;
        case 1: _t->getaddress((*reinterpret_cast< Widget*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SaveThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SaveThread::savedone)) {
                *result = 0;
                return;
            }
        }
